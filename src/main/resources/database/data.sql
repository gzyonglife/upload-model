...
VALUES ('admin', 'admin', '$2a$10$Q96zmpvV 4Udk81xT9ZfdbeF0zRezkHWiHt/jBIbG5391PObg2j35i', 0,
        current_timestamp(), 1),
...
('储备项目');
# 填充年度项目总览
insert into overview_year_plan(project_class_table_id, overview_year_plan_starts, overview_year_plan_complete) VALUES
(1,35,39),
(2,35,39),
(3,35,39);